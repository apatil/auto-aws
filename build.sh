...
ocamlfind ocamlc -g -pp camlp4of -I +camlp4 -package camlp4.quotations.o -package camlp4.lib -package yojson -package core -package str -thread -linkpkg generate.ml -o generate
